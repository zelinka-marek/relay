        ...
        <Form method="post">
          <div className="space-y-6">
            ...
            <div className="space-y-8 divide-y">
              <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-4">
                ...
                <div className="sm:col-span-full">
                  ...
                  <input
                    ...
                    aria-invalid={
                      actionData?.errors.avatarUrl ? true : undefined
                    }
              ...
              <div className="grid grid-cols-1 gap-y-6 pt-8 sm:grid-cols-6 sm:gap-x-4">
                <div className="sm:col-span-full">
                  <label
                    htmlFor="location"
                    className="block text-sm font-medium text-gray-700"
                  ...
                  <input
                    ...
                    aria-invalid={
                      actionData?.errors.location ? true : undefined
                    }
